...
class _HomePageState extends State<HomePage>{
  ...
  Future showNotification(int hour, String day) async {
    ...
    fltrNotification.zonedSchedule(1, "this is a notif", "Task", setupDayTime(hour, day), generalNotificationDetails, androidAllowWhileIdle: true, uiLocalNotificationDateInterpretation:
